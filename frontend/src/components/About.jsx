...
<img className='border-5 border-amber-200 md:h-50 md:w-100 h-30 w-30 rounded-4xl ms-2 opacity-70 brightness-100 contrast-100' src='WhatsApp Image 2025-08-09 at 2.05.48 PM.jpeg' ></img>
...
className="w-30 h-30 object-cover rounded-4xl md:h-55 md:w-55 opacity-90 brightness-90 contrast-100 border-5 border-amber-200"
alt="Founder"
/>
</div>
<div className="flex m-3  rounded-4xl p-3 items-center gap-4">
<img
src="WhatsApp Image 2025-08-09 at 2.06.15 PM (1).jpeg"
className="border-5 border-amber-200 w-30 h-30 object-cover rounded-4xl md:h-55 md:w-55 opacity-90 brightness-90 contrast-100"
alt="Founder"
/>
