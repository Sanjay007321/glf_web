...
<div className=' flex relative text-nowrap md:h-[150px] justify-between gap-2 md:justify-center p-2 md:flex-auto bg-gray-800'>
<img src='WhatsApp_Image_2025-08-09_at_2.05.48_PM-removebg-preview.png' className='animate-pulse duration-1000 h-15 m-4'></img>
<h1 className='mt-10 text-xl md:text-4xl animate-pulse bg-gradient-to-r from-yellow-200 via-amber-300 to-yellow-400 bg-clip-text text-transparent'>Good Life Foundation</h1>
<img src='WhatsApp_Image_2025-08-09_at_2.05.48_PM-removebg-preview.png' className='animate-pulse md:h-20 md:m-4 h-0'></img>
{ 
!menu ?
<svg onClick={togglemenu} className='transition-all animate-pulse duration-2000 ease-in-out h-10 w-10 ml-auto md:hidden m-5 mt-9 fill-cyan-950' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 6H20M4 12H20M4 18H20" stroke="cyan" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<title>Menu</title>
</svg> 
:
<svg onClick={togglemenu} className='transition-all animate-pulse duration-2000 ease-in-out h-10 w-10 ml-auto md:hidden m-5 mt-9 fill-cyan-950' viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<title>Cancel</title>
