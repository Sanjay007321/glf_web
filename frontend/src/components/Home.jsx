...
{ 
!menu ?
<svg onClick={togglemenu} className='transition-all animate-pulse duration-2000 ease-in-out h-8 w-8 ml-auto md:hidden m-5 mt-9 fill-cyan-950' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
<path d="M4 6H20M4 12H20M4 18H20" stroke="cyan" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<title>Menu</title>
</svg> 
:
<svg onClick={togglemenu} className='transition-all animate-pulse duration-2000 ease-in-out h-8 w-8 ml-auto md:hidden m-5 mt-9 fill-cyan-950' viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<title>Cancel</title>
